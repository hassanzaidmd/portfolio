        ...
        <div className="services__content">
          ...
          <div className={toggles ===1 ? "services__modal active-modal": "services__modal"} >
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">I specialize in building modern, user-centric websites that are not only visually appealing but also fast, responsive, and accessible across all devices.</p>
        ...
        <div className="services__content">
          ...
          <div className={toggles===3 ? "services__modal active-modal":"services__modal"}>
            <div className="services__modal-content">
              ...
              <p className="services__modal-description">I combine both frontend and backend expertise to develop complete, functional, and optimized web applications that deliver seamless user experiences</p>
              <ul className="services__modal-services grid">
                <li className="services__modal-service">
                  <i className="uil uil-check-circle services__modal-icon"></i>

                ...
                <i class='bx bx-download'></i>
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">DS College Katihar (Bihar)  </span>
                     <span>Percentage: 80.08
                                 <a href="apna certificate ka link dalo" className="home__social-icon" target="blank">
                ...
                <i class='bx bx-download'></i>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">Bihar School Examination Board   </span>
                         <span>Percentage: 84.8
                                 <a href="apna certificate ka link dalo" className="home__social-icon" target="blank">
